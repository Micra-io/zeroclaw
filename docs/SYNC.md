...
> Last clean re-baseline: 2026-06-27 onto upstream v0.8.2 (`docs/solutions/2026-06-27-v082-rebaseline-decisions.md`; full audit in gitignored `docs/superpowers/plans/2026-06-27-rebaseline-v082-plan.md`).
