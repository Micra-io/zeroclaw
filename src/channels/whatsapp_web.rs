                            ...
                            Event::Message(msg, info) => {
                                ...
                                let content = if content.is_empty() {
                                    if let Some(ref contact) = msg.contact_message {
                                        let line = if let Some(ref vcard) = contact.vcard {
                                        ...
                                        line
                                    } else if let Some(ref contacts_array) =
...
fn parse_vcard_fields(vcard: &str) -> Option<(String, Option<String>)> {
    ...
    for line in vcard.lines() {
        ...
        if let Some(value) = line.strip_prefix("FN:") {
            ...
            // TEL;type=CELL:+34612345678 or TEL:+34612345678
...
mod tests {
    ...
    // ── vCard contact extraction tests ──
