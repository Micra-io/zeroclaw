                    ...
                    async move {
                        ...
                        match &*event {
                            Event::Message(msg, info) => {
                                ...
                                // passive-context gates so that all group messages — whether
                                // or not they mention the bot — are captured for downstream
                                // processing. Runs pre-STT by design (matches upstream's
                                // no-provider-side-effects rule for unaddressed messages).
                                ...
                                if mention_only && is_group {
                                    ...
                                    if bot_phone.is_some() || bot_lid.is_some() {
                                        ...
                                        // otherwise record passive context (when enabled) or drop.
                                        ...
                                        } else if Self::should_record_passive_group_context(
                                            passive_group_context,
                                            is_group,
                                            false,
                                        ) {
